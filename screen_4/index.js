function handleResize() {
  if (window.innerWidth < 1112) {
    ...
    document.querySelector(".line-header-review").style.marginTop = "10px";
  } else {
    document.querySelector(".header-review").style.flexDirection = "";
    document.querySelector(".write-review").style.marginTop = "0px";
    document.querySelector(".line-header-review").style.marginTop = "-44px";
  }
  if (window.innerWidth < 1112) {
...
function showImg(e) {
  var i;
  const dataReview = document.querySelectorAll(".review_container");
